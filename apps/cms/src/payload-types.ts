...
export interface Config {
  ...
  collectionsSelect: {
    ...
    new_session_welcome: NewSessionWelcomeSelect<false> | NewSessionWelcomeSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "dashboard_items".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "dashboard_items_select".
 */
export interface DashboardItemsSelect<T extends boolean = true> {
  name?: T;
  description?: T;
  query?: T;
  type?: T;
